                        ...
                        <div className="col-xl-6 col-md-12">
                            <div className="banner__left">
                                <div className="block-text">
                                    <h2 className="heading">The Easiest Way
                                    To Invest in  Real <span className="s1 arlo_tm_animation_text_word" /> <br />
                                    Estate</h2>
                                    <p className="desc">Dione Island Club has taken real estate investing to a new level. Each luxury villa was divided into parts and converted into NFTs, allowing owners to purchase a slice of their own paradise.</p><br />
                                    <Link href="/contact" className="action-btn"><span>Whitepaper</span></Link><Link href="/contact" className="action-btn"><span>Audit</span></Link>
                                </div>
                                <div className="pay">
                                    <div className="list">
