                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12">
                            <div className="block-text center">
                                <h6 className="sub-heading"><span>Speciality</span></h6>
                                <h3 className="heading wow">Complete solution for your <br />
                    ...
                    <div className="col-xl-3 col-md-6">
                        <div className="speciality-box" data-aos="fade-up" data-aos-duration={2000}>
                            ...
                            <h5 className="title">Real Estate</h5>
                    ...
                    <div className="col-xl-3 col-md-6">
                        <div className="speciality-box" data-aos="fade-up" data-aos-duration={3000}>
                            ...
                            <h5 className="title">Own wallet</h5>
                            <p>Oficia dese runt mollit anim id est labo met, consectetur adipis</p>
