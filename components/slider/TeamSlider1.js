            ...
            <Swiper {...swiperOptions}>
                    ...
                    <div className="team-box">
                        ...
                        <div className="content">
                            ...
                            <ul className="list-social">
                                <li><Link href="https://www.facebook.com/dioneislandclub/">
                                ...
                                <li><Link href="https://twitter.com/PeterMichaelusa">
                ...
                <SwiperSlide>
                    <div className="team-box">
                        ...
                        <div className="content">
                            <Link href="/team" className="h5 name">Jonathan Brito </Link>
                            <p className="postion">
                                Designer
                            </p>
                            <ul className="list-social">
                ...
                <SwiperSlide>
                    <div className="team-box">
                        ...
                        <div className="content">
                            <Link href="/team" className="h5 name">Fanny Edwards</Link>
                            <p className="postion">
                                Developer
                            </p>
                            <ul className="list-social">
                ...
                <SwiperSlide>
                    <div className="team-box">
                        ...
                        <div className="content">
                            <Link href="/team" className="h5 name">Sanju Devi</Link>
                            <p className="postion">
                                3D Artist
                            </p>
                            <ul className="list-social">
