...
import CardSlider1 from "@/components/slider/CardSlider1"
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <div className="block-text center">
                                        <h2 className="heading">Discover Rare Digital Art
                                        </h2>
                                        <p className="mb-34">The largest and most unique digital marketplace of vintage for crypto-collectibles and non-fungible tokens (NFTs)</p>
                            ...
                            <div className="row justify-content-center">
                                ...
                                <div className="col-xl-3 col-md-6">
                                    <div className="team-box">
                                        ...
                                        <div className="content">
                                            <Link href="/team" className="h5 name">Peter Michael</Link>
                                            <p className="postion">
                                                Founder &amp; CEO
                                            </p>
                                        </div>
